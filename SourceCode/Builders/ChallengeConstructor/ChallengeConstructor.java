...
public abstract class ChallengeConstructor extends JFrame {
    ...
    public ChallengeConstructor(JFrame parent, Runnable onReturn) {
        ...
        rawRunImg      = new ImageIcon("Buttons/RunButton.png").getImage();
        rawSubmitImg   = new ImageIcon("Buttons/SubmitButton.png").getImage();
        rawMainMenuImg = new ImageIcon("Buttons/MainMenuButton.png").getImage();
